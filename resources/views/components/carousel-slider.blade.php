...
<div class="relative p-4">
    <div class="bg-transparent focus:bg-gray-200 focus:bg-opacity-50 hover:bg-gray-200 hover:bg-opacity-50 text-black w-full flex justify-between absolute bottom-0 left-0 z-10 border-2 border-purple-600">
        <a class="pl-4 cursor-pointer" x-on:click="moveScroll(0, -300, '.carousel')">
        ...
        <a class="pr-4 cursor-pointer" x-on:click="moveScroll(0, 300, '.carousel')">
    ...
    <div class="carousel carousel-center max-w-md p-4 space-x-6 bg-white max-w-[220px] h-full">
